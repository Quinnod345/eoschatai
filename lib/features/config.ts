...
export const FEATURES: Feature[] = [
  ...
  // Voice & Audio Features
  {
    ...
    description: 'Hands-free conversations with real-time voice interaction',
    category: 'core',
    version: '2.1',
    ...
    icon: 'Mic',
    detailedDescription:
      'Revolutionary voice interaction that brings natural conversation to AI chat. Speak naturally and get immediate voice responses, making AI conversations feel more human and accessible.',
    benefits: [
      'Real-time speech-to-text with high accuracy',
      'Natural voice responses with AI-generated speech',
      'Hands-free operation perfect for multitasking',
      'Multiple voice options and speed controls',
      'Seamless integration with all chat features',
      'Background processing for uninterrupted workflow',
      'Accessibility support for vision-impaired users',
    ],
    examples: [
      'Ask questions while working on other tasks',
      'Get meeting briefings while commuting',
      'Brainstorm ideas during walks or exercise',
      'Accessible AI interaction for all users',
    ],
    improveExperience: [
      'More natural and intuitive AI interactions',
      'Multitask while getting AI assistance',
      'Improved accessibility for all users',
      'Faster communication than typing',
    ],
    tags: ['voice', 'speech', 'accessibility', 'hands-free', 'beta'],
  },
  {
    id: 'vocal-recording-suite',
    title: 'Vocal Recording Suite',
    description:
      'Professional meeting recording, transcription, and AI analysis',
    category: 'productivity',
    version: '2.1',
    releaseDate: '2024-12-15',
    isNew: true,
    icon: 'FileAudio',
    screenshot: '/images/features/vocal-recording-suite.png',
    detailedDescription:
      'Complete meeting recording and analysis solution that transforms your conversations into actionable insights. Record, transcribe, analyze, and act on meeting content with AI assistance. Features a beautiful, professional interface with real-time processing and comprehensive analysis tools.',
    benefits: [
      'High-quality audio recording with pause/resume functionality',
      'Advanced speaker diarization (up to 4+ speakers)',
      'Real-time transcription with speaker identification',
      'AI-generated meeting summaries and key insights',
      'Automatic action item extraction and follow-up suggestions',
      'Searchable recording library with rich metadata',
      'Multiple export options (text, PDF, audio)',
      'Direct integration with EOS AI for business analysis',
      'Beautiful, intuitive interface with professional design',
      'Secure local storage with cloud backup options',
    ],
    examples: [
      'Record team standup meetings and get automated summaries',
      'Transcribe client sales calls with speaker identification',
      'Extract action items from project planning sessions',
      'Analyze meeting patterns and team participation metrics',
      'Create searchable archives of important business conversations',
      'Generate meeting minutes automatically for board meetings',
      'Review one-on-one sessions with detailed insights',
    ],
    improveExperience: [
      'Never miss important meeting details or action items again',
      'Spend less time taking notes, more time actively participating',
      'Get AI-powered insights on meeting effectiveness and outcomes',
      'Build a comprehensive, searchable knowledge base of discussions',
      'Improve team accountability with clear action item tracking',
      'Enhance meeting follow-up with detailed summaries and transcripts',
      'Save hours of manual transcription and note-taking work',
    ],
    tags: [
      'recording',
      'transcription',
  ...
  },
  {
    ...
    improveExperience: [
      'Create better content with AI assistance',
      'Work more efficiently with advanced tools',
      'Never lose work with version tracking',
  ...
  // User Interface Enhancements
  {
    ...
    tags: ['animations', 'ui', 'framer-motion', 'transitions', 'polish'],
  },
  {
