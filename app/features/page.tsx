  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'GSAP and Framer Motion animations for delightful interactions',
      },
      {
        icon: Activity,
...
export default function FeaturesPage() {
  ...
  useGSAP(
    () => {
      ...
      // Feature card animations - Fixed to ensure visibility
      gsap.utils.toArray('.feature-item').forEach((card: any, index) => {
        // Ensure the card is visible first
        gsap.set(card, { visibility: 'visible', opacity: 1 });
    ...
    >
      ...
      <main className="flex-1">
        ...
        >
          <div className="container mx-auto px-4 md:px-6 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="hero-subtitle text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
        ...
        {featureCategories.map((category, categoryIndex) => (
          <section
            key={category.id}
            className="category-section py-16 md:py-20 relative overflow-hidden"
          >
            {categoryIndex % 2 === 1 && (
                ...
                {category.features.map((feature, featureIndex) => {
                  ...
                  return (
                    <div
                      ...
                      className="feature-item glass-morphism rounded-2xl p-6 depth-shadow card-3d group hover:shadow-glow-sm transition-all duration-300"
                    >
                      <div
