...
export const AILoaderIcon = ({ size = 16 }: { size?: number }) => {
    ...
    >
      ...
      >
        ...
        >
          <animate
            attributeName="rx"
            values="40;43;41;44;40;38;36;38;40"
            dur="5.2s"
            repeatCount="indefinite"
          />
          <animate
            attributeName="ry"
            values="15;16.5;15.5;17;15;14;13;14;15"
            dur="5.2s"
            repeatCount="indefinite"
          />
          <animate
            attributeName="opacity"
            values="0.8;0.9;0.85;0.95;0.8;0.75;0.7;0.75;0.8"
            dur="5.2s"
            repeatCount="indefinite"
          />
        </ellipse>
        <g transform="translate(0, 10)">
          <animateTransform
            ...
            dur="6s"
            repeatCount="indefinite"
            values="0 10; 0 8.8; 0 8.0; 0 9.2; 0 10.4; 0 11.0; 0 10.2; 0 9.6; 0 10"
            keyTimes="0; 0.12; 0.24; 0.36; 0.5; 0.64; 0.76; 0.88; 1"
            calcMode="spline"
            keySplines=".25 .1 .25 1; .25 .1 .25 1; .25 .1 .25 1; .25 .1 .25 1; .25 .1 .25 1; .25 .1 .25 1; .25 .1 .25 1; .25 .1 .25 1"
          />
          <animateTransform
            attributeName="transform"
            additive="sum"
            ...
            dur="8s"
            repeatCount="indefinite"
            values="0 50 50; 0.4 50 50; 0 50 50; -0.3 50 50; 0 50 50"
            keyTimes="0; 0.2; 0.5; 0.8; 1"
            calcMode="spline"
            keySplines=".25 .1 .25 1; .25 .1 .25 1; .25 .1 .25 1; .25 .1 .25 1"
          />
          <path
            fill="url(#eosGradIdle)"
            d="M40.1,30.7L24.6,6.9C32.1,2.5,40.7,0,50,0s17.9,2.5,25.3,6.9L59.9,30.7c-3.4-1.8-7.3-2.7-11.4-2.4 C45.5,28.5,42.6,29.3,40.1,30.7z"
          />
          <path
            fill="url(#eosGradIdle)"
            d="M70.7,47.8H100C99.3,31.9,91.2,18,79.1,9.3L63.6,33.3C67.7,36.8,70.4,42,70.7,47.8z"
          />
          <path
            fill="url(#eosGradIdle)"
            d="M29.3,47.6 c0.4-5.7,3.1-10.8,7.1-14.3L20.9,9.3C8.8,18,0.7,31.9,0,47.8h29.3C29.3,47.7,29.3,47.7,29.3,47.6z"
          />
          <path
            fill="url(#eosGradIdle)"
            d="M34.7,63 c-2.7-2.9-4.5-6.6-5.2-10.7H0c0.7,15.8,8.8,29.8,20.9,38.4L37,65.9C36.3,64.9,35.5,63.9,34.7,63z"
          />
          <path
            fill="url(#eosGradIdle)"
            d="M65.4,62.9c-0.9,0.9-1.7,1.9-2.4,3 l16.2,24.9c12.1-8.7,20.2-22.6,20.9-38.4H70.5C69.8,56.4,68,60,65.4,62.9z"
          />
          <path
            fill="url(#eosGradIdle)"
            d="M60.4,70.3l14.9,23c-7.4,4.4-16.1,6.9-25.3,6.9 s-17.9-2.5-25.3-6.9l14.9-23c0.8,1.6,1.4,3.4,1.8,5.1l0.4,1.7h16.4l0.4-1.5C59,73.7,59.6,71.9,60.4,70.3z"
          />
          <path
            fill="url(#eosGradIdle)"
            d="M57.1,85.6H42.8 c0,1.7,1.4,3.1,3.1,3.1H54c0.9,0,1.6-0.4,2.2-0.9C56.8,87.2,57.1,86.4,57.1,85.6z"
          />
          <path
            fill="url(#eosGradIdle)"
            d="M59.4,81.3c0-1.1-0.9-2-2-2H42.5c-1.1,0-2,0.9-2,2 c0,1.1,0.9,2,2,2h14.9C58.6,83.3,59.4,82.5,59.4,81.3z"
          />
        </g>
      </svg>
      <style jsx>{`
        @keyframes subtle-breathe { 0%, 100% { opacity: 1; } 50% { opacity: 0.96; } }
        .eos-slice-idle { transform-origin: 50% 60%; animation: subtle-breathe 4s ease-in-out infinite; }
      `}</style>
    </span>
  );
};

export const AIActiveLoaderIcon = ({ size = 16 }: { size?: number }) => {
  const dimension = typeof size === 'number' ? `${size}px` : size;
  return (
    <span
      className="inline-block relative"
      ...
      >
        <defs>
          ...
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset="0" stopColor="#F04E23" stopOpacity="0.6" />
            <stop offset="0.63" stopColor="#FF7900" stopOpacity="0.6" />
          </linearGradient>
...
export const AILoaderIcon2 = ({ size = 16 }: { size?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlnsXlink="http://www.w3.org/1999/xlink"
    viewBox="0 0 720 720"
  ...
  >
    <defs>
      <clipPath id="__lottie_element_91">
        <rect width="720" height="720" x="0" y="0" className="svg-elem-4" />
      </clipPath>
    </defs>
    <g clipPath="url(#__lottie_element_91)">
      <g
        transform="matrix(15,0,0,15,0,0)"
        opacity="1"
        style={{ display: 'block' }}
      >
        <g opacity="1" transform="matrix(1,0,0,1,24,24)">
          <path
            ...
            strokeOpacity="1"
            strokeWidth="2.4"
            d="M0.12200000137090683,-14.520000457763672 C-1.4160000085830688,-15.475000381469727 -3.2139999866485596,-16.024999618530273 -5.136000156402588,-16.024999618530273 C-10.809000015258789,-16.024999618530273 -15.407999992370605,-11.241999626159668 -15.407999992370605,-5.3420000076293945 C-15.407999992370605,-5.3420000076293945 -15.407999992370605,-5.3420000076293945 -15.407999992370605,-5.3420000076293945 C-15.407999992370605,-2.450000047683716 -14.303000450134277,0.17499999701976776 -12.508999824523926,2.0980000495910645 C-12.069000244140625,2.569999933242798 -11.513999938964844,2.9159998893737793 -10.895000457763672,3.0510001182556152 C-10.883999824523926,3.052999973297119 -10.87399959564209,3.056999921798706 -10.86299991607666,3.059000015258789 C-10.119999885559082,3.2119998931884766 -9.359999656677246,2.947999954223633 -8.82699966430664,2.3889999389648438 C-8.378999710083008,1.9179999828338623 -7.874000072479248,1.1369999647140503 -7.874000072479248,0.0010000000474974513 C-7.874000072479248,0.0010000000474974513 -7.874000072479248,-0.0010000000474974513 -7.874000072479248,-0.0010000000474974513 C-7.874000072479248,-1.1360000371932983 -8.378999710083008,-1.9190000295639038 -8.82699966430664,-2.3889999389648438 C-9.359999656677246,-2.947999954223633 -10.119999885559082,-3.2119998931884766 -10.86299991607666,-3.059000015258789 C-10.87399959564209,-3.055999994277954 -10.883999824523926,-3.052999973297119 -10.895000457763672,-3.0510001182556152 C-11.513999938964844,-2.9149999618530273 -12.069000244140625,-2.569000005722046 -12.508999824523926,-2.0959999561309814 C-14.303000450134277,-0.17299999296665192 -15.407999992370605,2.4489998817443848 -15.407999992370605,5.3420000076293945 C-15.407999992370605,11.241000175476074 -10.809000015258789,16.024999618530273 -5.136000156402588,16.024999618530273 C-2.3550000190734863,
.843999981880188,-8.71399974822998 -1.093000054359436,-8.187999725341797 -0.0010000000474974513,-8.187999725341797 C-0.0010000000474974513,-8.187999725341797 0.0010000000474974513,-8.187999725341797 0.0010000000474974513,-8.187999725341797 C1.093000054359436,-8.187999725341797 1.8450000286102295,-8.71399974822998 2.296999931335449,-9.180000305175781 C2.8350000381469727,-9.734000205993652 3.0880000591278076,-10.524999618530273 2.940999984741211,-11.29800033569336 C2.938999891281128,-11.309000015258789 2.936000108718872,-11.319999694824219 2.934000015258789,-11.331000328063965 C2.812000036239624,-11.932999610900879 2.513000011444092,-12.47599983215332 2.1040000915527344,-12.916999816894531"
            className="svg-elem-5"
          />
        </g>
      </g>
      <g
        transform="matrix(15.652170181274414,0,0,15.3191499710083,0.0003662109375,0.007110595703125)"
        opacity="1"
        style={{ display: 'block' }}
      >
        <g
          opacity="1"
          transform="matrix(1,0,0,1,22.972000122070312,23.038999557495117)"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M6.73905 1.64313L6.73827 1.64115C6.57313 0.995553 5.99149 0.5 5.3 0.5H3.7C3.00851 0.5 2.42687 0.995553 2.26173 1.64115L2.26095 1.64313L1.98298 3.17925C1.4342 3.45336 0.934356 3.81468 0.502349 4.24326L0.5 4.24559C-0.166667 4.91224 -0.166667 5.98776 0.5 6.65441L0.502349 6.65674C0.934356 7.08532 1.4342 7.44664 1.98298 7.72075L2.26095 9.25688L2.26173 9.25885C2.42687 9.90445 3.00851 10.4 3.7 10.4H5.3C5.99149 10.4 6.57313 9.90445 6.73827 9.25885L6.73905 9.25688L7.01702 7.72075C7.5658 7.44664 8.06564 7.08532 8.49765 6.65674L8.5 6.65441C9.16667 5.98776 9.16667 4.91224 8.5 4.24559L8.49765 4.24326C8.06564 3.81468 7.5658 3.45336 7.01702 3.17925L6.73905 1.64313ZM4.5 7.5C5.60457 7.5 6.5 6.60457 6.5 5.5C6.5 4.39543 5.60457 3.5 4.5 3.5C3.39543 3.5 2.5 4.39543 2.5 5.5C2.5 6.60457 3.39543 7.5 4.5 7.5Z"
        fill="currentColor"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M14.7391 6.64313L14.7383 6.64115C14.5731 5.99555 13.9915 5.5 13.3 5.5H11.7C11.0085 5.5 10.4269 5.99555 10.2617 6.64115L10.261 6.64313L9.98298 8.17925C9.4342 8.45336 8.93436 8.81467 8.50235 9.24326L8.5 9.24559C7.83333 9.91224 7.83333 10.9878 8.5 11.6544L8.50235 11.6567C8.93436 12.0853 9.4342 12.4466 9.98298 12.7208L10.261 14.2569L10.2617 14.2588C10.4269 14.9044 11.0085 15.4 11.7 15.4H13.3C13.9915 15.4 14.5731 14.9044 14.7383 14.2588L14.7391 14.2569L15.017 12.7208C15.5658 12.4466 16.0656 12.0853 16.4977 11.6567L16.5 11.6544C17.1667 10.9878 17.1667 9.91224 16.5 9.24559L16.4977 9.24326C16.0656 8.81467 15.5658 8.45336 15.017 8.17925L14.7391 6.64313ZM12.5 12.5C13.6046 12.5 14.5 11.6046 14.5 10.5C14.5 9.39543 13.6046 8.5 12.5 8.5C11.3954 8.5 10.5 9.39543 10.5 10.5C10.5 11.6046 11.3954 12.5 12.5 12.5Z"
        fill="currentColor"
      />
    </svg>
  );
